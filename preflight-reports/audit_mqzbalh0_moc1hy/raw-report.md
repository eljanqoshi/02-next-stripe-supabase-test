...
- Audit: audit_mqzbalh0_moc1hy
- Repository: eljanqoshi/02-next-stripe-supabase-test
- Branch: main
- App path: .
- Framework: next
- Scan mode: sandbox
- Generated: 2026-06-29T14:33:38Z
...
[ok] Generating static pages using 1 worker (6/6) in 122ms
...
End status: 1177 dirs visited, 12812 inodes visited, 9 Extract calls, 749.206421ms elapsed, 749.206561ms wall time
...
Content-Length: 4477
Date: Mon, 29 Jun 2026 14:29:38 GMT
...
Starting Nmap 7.99 ( https://nmap.org ) at 2026-06-29 14:29 +0000
...
SF-Port3000-TCP:V=7.99%I=7%D=6/29%Time=6A42813C%P=x86_64-pc-linux-gnu%r(Ge
SF:tRequest,131C,"HTTP/1\.1\x20200\x20OK\r\nVary:\x20rsc,\x20next-router-s
...
SF:ent-Length:\x204477\r\nDate:\x20Mon,\x2029\x20Jun\x202026\x2014:29:16\x
SF:20GMT\r\nConnection:\x20close\r\n\r\n<!DOCTYPE\x20html><html\x20lang=\"
SF:en\"><head><meta\x20charSet=\"utf-8\"/><meta\x20name=\"viewport\"\x20co
SF:ntent=\"width=device-width,\x20initial-scale=1\"/><link\x20rel=\"preloa
SF:d\"\x20as=\"script\"\x20fetchPriority=\"low\"\x20href=\"/_next/static/c
SF:hunks/3z5q_p4msz2ha\.js\"/><script\x20src=\"/_next/static/chunks/0atut6
SF:a2uuyid\.js\"\x20async=\"\"></script><script\x20src=\"/_next/static/chu
SF:nks/2nykiepra7i1k\.js\"\x20async=\"\"></script><script\x20src=\"/_next/
SF:static/chunks/turbopack-1ncs5q5sgtvda\.js\"\x20async=\"\"></script><scr
SF:ipt\x20src=\"/_next/static/chunks/158m")%r(Help,2F,"HTTP/1\.1\x20400\x2
SF:0Bad\x20Request\r\nConnection:\x20close\r\n\r\n")%r(NCP,2F,"HTTP/1\.1\x
...
SF:un\x202026\x2014:29:16\x20GMT\r\nConnection:\x20close\r\n\r\nMethod\x20
...
SF:AD\r\nDate:\x20Mon,\x2029\x20Jun\x202026\x2014:29:16\x20GMT\r\nConnecti
...
+ Target Port:        3000
+ Platform:           Unknown
+ Start Time:         2026-06-29 14:29:19 (GMT0)
---------------------------------------------------------------------------
...
+ [740002] /: Potential OPTIONSBLEED vulnerability detected. Allow header: ARRAY(0x559fd7359ab8). See: https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-9798
+ [999990] OPTIONS: Allowed HTTP Methods: ARRAY(0x559fd7357fd8) .
...
+ End Time:           2026-06-29 14:29:38 (GMT0) (19 seconds)
---------------------------------------------------------------------------
+ 1 host(s) tested
```
